...
const button = document. querySelector("#myText")

// Adiciona um "ouvinte" de evento ao botconão. Quando o botão for clicado, a função dentro do 'addEventListener' será executada
